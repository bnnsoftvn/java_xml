...
public enum RespCode {
    ...
    BAD_SIGNATURE_HMAC(103, "Lỗi chữ kí HMAC"),
    MFA_ACTIVATE_REQUIRED(204, "Yêu cầu kích hoạt MFA"),
    MFA_REQUEST_REQUIRED(205, "Yêu cầu xác thực MFA"),
    ...
    SIGNATURE_INVALID(1003, "Chữ kí không hợp lệ"),
    PRIVATE_KEY_NOTFOUND(1004, "Không tìm thấy Private key"),
    ...
    SIGN_FAIL(3003, "Lỗi trong quá trình kí"),
    DATAINPUT_INVALID(6100, "Lỗi dữ liệu đầu vào"),
